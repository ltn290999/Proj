...
public class AddressController {
	...
	List<Address> listAddresses = addressService.listAdressBook(customer);
	...
	return "test/address_book/addresses";
...
//	return "address_book/address_form";
	return "test/address_book/address_form";
    }
	...
	ra.addFlashAttribute("message", "The address ID " + addressId + " has bene deleted.");
